...
public class BST<Key extends Comparable<Key>, Value> {
    ...
    ***********************************************************************/
    ...
    public Iterable<Key> inOrder(Node x, Queue<Key> keys) {
        if(x.left != null)
		inOrder(x.left, keys);
    ...
    public Iterable<Key> preOrder(Node x, Queue<Key> keys) {
    ...
    public Iterable<Key> postOrder(Node x, Queue<Key> keys) {
  ...
  /*************************************************************************
    ...
    *****************************************************************************/
    public static void main(String[] args) { 
        ...
        BST<String, Integer> st4 = new BST<String, Integer>();
	...
	System.out.println("In Order");
        for (String z : st4.inOrder())
            StdOut.println(z + " " + st4.get(z));

        StdOut.println();

	System.out.println("Preorder Traversal");
        for (String t : st2.preOrder())
            StdOut.println(t + " " + st2.get(t));

        StdOut.println();

	System.out.println("Postorder Traversal");
        for (String u : st3.postOrder())
            StdOut.println(u + " " + st3.get(u));
}
